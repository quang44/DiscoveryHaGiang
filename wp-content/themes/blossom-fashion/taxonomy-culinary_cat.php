...
?>
    ...
    <div class="products_list">
        <div class="list_content">
            <div class="profil_col3_menu">
                <div class="main_fill">
                    <div class="tabel">
                        <div class="list-danhmuc-sp">
                            <?php foreach ($menus as $key => $menuItem1) {
                                $link1 = get_term_link($menuItem1->slug, 'culinary_cat');
                                $active1 = (($url == $link1) ? 'checked="checkbox"' : '');
                                ?>
                                <div class="label">
                                    <label class="danhmuc-sp">
                                        <input id="checkjs-<?= $key ?>" class="dashtitle checkjs" <?= $active1 ?>
                                               name="" type="radio">
                                        ...
                                        if ($menuItem1->child_items) : ?>
                                            <div class="item_fields">
                                                <ul class="extra">
                                                    <?php
                                                    $activejs = '';
                                                    foreach ($menuItem1->child_items as $menuItem2) :
                                                        $link2 = get_term_link($menuItem2->slug, 'culinary_cat');
                                                    ...
                                                    <?php if ($activejs): ?>
                                                        <script>
                                                            $(document).ready(function () {
                                                                document.getElementById("checkjs-<?= $key ?>").checked = true;
                                                            })
                                                        </script>
                                                    <?php endif; ?>
                               ...
                               data-wow-delay="0.3s">
                                ...
                                <div class="detail-item">
                                    ...
                                    <div class="maps">
                                        ...
                                        <div class="title16"><?php echo wp_trim_words(the_excerpt(), 40, '...'); ?></div>
                                    </div>
                                </div>
                            </a>
                        <?php endwhile;
