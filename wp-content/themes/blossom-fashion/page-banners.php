			...
			<div class="main_fill">
				<div class="tabel">
					<div class="list-danhmuc-sp">
						<?php foreach ($taxonomies as $hotel_cat) {
							$link = get_term_link($hotel_cat->slug, 'hotel_cat');
							...
							<div class="label">
								<a href="<?= $link ?>" title="" class="danhmuc-sp">
									...
									<div class="item_title">
										<h3 class="title16 link_text"><?= $hotel_cat->name ?></h3>
									</div>
								</a>
							</div>
						<?php } ?>
			...
			if ($wp_query->have_posts()) : ?>
				<div class="flex_products">
					<?php while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
						<a href="<?php the_permalink(); ?>" title="" class="single-product wow fadeIn" data-wow-delay="0.3s">
							...
							<div class="detail-item">
								...
								<div class="maps">
									...
									<p class="title16"><?php echo wp_trim_words(get_the_content(), 40, '...'); ?></p>
								</div>
							</div>
						</a>
