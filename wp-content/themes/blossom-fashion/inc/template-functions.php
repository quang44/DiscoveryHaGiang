...
function blossom_fashion_page_start(){
    ?>
<div id="page" class="site"><a aria-label="<?php esc_attr_e('skip to content', 'blossom-fashion'); ?>" class="skip-link"
                               href="#content"><?php esc_html_e('Skip to Content', 'blossom-fashion'); ?></a>
    <?php
}
endif;
...
if (!function_exists('blossom_fashion_header')) :
    ...
    function blossom_fashion_header()
    {
        ...
        <header class="site-header" itemscope itemtype="http://schema.org/WPHeader" itemscope
                                ...
                                <div class="right-item">
                                    <ul class="language">
                                        <li id="vi" onclick="doGTranslate('en|vi')">
                                            <img src="<?= home_url() ?>/wp-content/themes/blossom-fashion/images/icon/vn.png">
                                        </li>
                                        <li id="en" onclick="doGTranslate('en|en')">
                                            <img src="<?= home_url() ?>/wp-content/themes/blossom-fashion/images/icon/eng.png">
                                        </li>
                                    </ul>
                            ...
                            <div class="col">
                                <div class="text-logo" itemscope itemtype="http://schema.org/Organization">
                                    ...
                                    <div class="site-title-wrap">
                                        <?php
                                        if (is_front_page()) { ?>
                                            <h1 class="site-title" itemprop="name"><a
            ...
            <div class="nav-holder">
                <div class="container">
                    ...
                    <button aria-label="<?php esc_attr_e('primary menu toggle', 'blossom-fashion'); ?>"
                            id="toggle-button" data-toggle-target=".main-menu-modal"
                    ...
                    <nav id="site-navigation" class="main-navigation" itemscope
                        ...
                        <div class="primary-menu-list main-menu-modal cover-modal"
                            ...
                            <button class="btn-close-menu close-main-nav-toggle" data-toggle-target=".main-menu-modal"
                                    data-toggle-body-class="showing-main-menu-modal" aria-expanded="false"
                    ...
                    <div class="tools">
                        <div class="form-section">
                            <button aria-label="<?php esc_attr_e('search toggle', 'blossom-fashion'); ?>"
                                    id="btn-search" data-toggle-target=".search-modal"
                                    data-toggle-body-class="showing-search-modal"
                                    data-set-focus=".search-modal .search-field" aria-expanded="false"><i
                                        class="fa fa-search"></i></button>
                            <div class="form-holder search-modal cover-modal" data-modal-target-string=".search-modal">
                                <div class="header-search-inner-wrap">
                                    <?php get_search_form(); ?>
                                    <button class="btn-close-form" data-toggle-target=".search-modal"
                                            data-toggle-body-class="showing-search-modal"
...
//    echo (is_tax()) ?"true" : "ok";
        if (is_page_template('page-hotel.php') || is_single() || is_page_template('page-amthuc.php')) {
            get_template_part('template-parts/content-banner', '');
        } if (is_page_template('page-restaurant.php') ) {
        get_template_part('template-parts/content-banner', '');
    }
        if (is_page_template('page-stay.php') ) {
            get_template_part('template-parts/content-banner', '');
        }
    }
endif;
                                        ...
                                        <div class="product-image">
                                            ...
                                            if ($product->is_type('simple') && $stock == 'instock') { ?>
                                                <a href="javascript:void(0);" rel="bookmark"
                                                   class="btn-add-to-cart btn-simple"
                                                   id="<?php the_ID(); ?>"><?php esc_html_e('Add to Cart', 'blossom-fashion'); ?></a>
                                                <?php
                                            } else { ?>
                                                <a href="<?php the_permalink(); ?>" rel="bookmark"
                                                   class="btn-add-to-cart"><?php esc_html_e('View Details', 'blossom-fashion'); ?></a>
                                                <?php
                                            }
                                            ?>
                                        </div>
...
<?php if (!is_singular('hotel')){ ?>
    <div class="container">
    <? } ?>

    <?php
//     echo (is_singular('hotel')) ? "true" : "null";
    /**
     * Page Header for category archive & single page.
     */
    if (!is_front_page() && ((is_archive() && !is_author()) || (is_page() && !is_page_template('page-hotel.php') && !is_page_template('page-amthuc.php') && !is_page_template('page-restaurant.php') && !is_page_template('page-stay.php')) || (is_tax() && !is_tax('hotel_cal') && !is_tax('culinary')))) { ?>
            ...
            <div class="foot_col0">
                <div class="foot_pro">
                    <div class="container container-footer">
                        <div class="row-flex column-<?php echo esc_attr($sidebar_count); ?>">
                            <?php foreach ($active_sidebars as $active) { ?>
                                <div class="item_foot">
                                    <?php dynamic_sidebar($active); ?>
                                </div>
